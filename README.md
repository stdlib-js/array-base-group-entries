...
```javascript
groupEntries = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-group-entries@v0.2.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/array-base-group-entries/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/array-base-group-entries/actions/workflows/test.yml?query=branch:v0.2.1
